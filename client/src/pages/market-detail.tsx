...
export default function MarketDetail() {
  ...
  // Get current user from global state (in real app, this would be from context)
  useEffect(() => {
    // Mock user - in real implementation, get from auth context
    const mockUser = { id: "user1", walletAddress: "0x123..." };
    ...
    <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Trading Panel */}
          <div className="space-y-6">
            <TradingInterface market={market} currentUser={currentUser} />
